...
(function(ns) {
    ...
    Object.keys(ns.emojioneList).forEach(function(i) {
        // If unicode not present, it means it's the same as uc. So let's use that!
        if (!ns.emojioneList[i].unicode) {
            ns.emojioneList[i].unicode = [ns.emojioneList[i].uc]
        }
    })
    ...
    ns.shortnameToUnicode = function(str) {
        ...
        str = str.replace(ns.regShortNames, function(shortname) {
            ...
            fname = ns.emojioneList[shortname].fname || uc
    ...
    ns.unicodeToImage = function(str) {
        ...
        str = str.replace(ns.regUnicode, function(unicodeChar) {
            if ((typeof unicodeChar === 'undefined') || (unicodeChar === '') || (!(unicodeChar in ns.jsEscapeMap))) {
                ...
                fname = ns.emojioneList[short].fname || ns.emojioneList[short].uc
    ...
    ns.memoizeReplacement = function() {
        if (!ns.unicodeReplacementRegEx || !ns.memMapShortToUnicodeCharacters) {
            ...
            ns.mapEmojioneList(function(unicode, shortname) {
                ...
                if (ns.emojioneList[shortname].isCanonical !== false) {
